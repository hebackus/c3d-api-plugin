<!-- ObjectARX and Managed .NET > ObjectARX: Managed .NET Developer's Guide > About .NET and the AutoCAD .NET API (.NET) > Overview of Microsoft Visual Studio (.NET) > Which Edition of Microsoft Visual Studio to Use (.NET) -->
<!-- Source: https://help.autodesk.com/cloudhelp/2026/ENU/OARX-DevGuide-Managed/files/GUID-450FD531-B6F6-4BAE-9A8C-8230AAC48CB4.htm -->
...
If you are targeting AutoCAD 2026 or AutoCAD 2026-based programs, you should use: 

  * Microsoft Visual Studio 2022 version 17.10.4 
  * Microsoft .NET 8.0 
...
For more information on the different editions of Microsoft Visual Studio, see _https://www.visualstudio.com/_ and _https://www.visualstudio.com/vs/community/_. 
...
Note: Applications compiled with Microsoft Visual Studio 2019 version 16.0 or later should load into AutoCAD 2026 or AutoCAD 2026-based programs without any problems. 
